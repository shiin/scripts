...
if [[ -e /usr/local/bin/enlightenment ]]; then
    ...
    sudo apt install -y ccache libtool check libssl-dev libsystemd-dev libjpeg-dev \
        libglib2.0-dev libgstreamer1.0-dev libluajit-5.1-dev libfreetype6-dev \
        libfontconfig1-dev libfribidi-dev

    sudo apt install -y libx11-dev libxcursor-dev libxrender-dev libxrandr-dev \
    ...
    sudo apt install -y libpam0g-dev   # Required for Enlightenment
